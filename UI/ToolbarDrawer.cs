    ...
    public class ToolbarDrawer
    {
...

        {
            ...
            this.iconPaths = new Dictionary<DrawMode, string>
            {
                ...
                { DrawMode.Donut, "" },
                { DrawMode.Starburst, "PluginImages.svg.starburst.webp" },
                { DrawMode.SquareImage, "PluginImages.toolbar.Square.webp" },
                { DrawMode.CircleMarkImage, "PluginImages.toolbar.CircleMark.webp" },
                { DrawMode.TriangleImage, "PluginImages.toolbar.Triangle.webp" },
                { DrawMode.PlusImage, "PluginImages.toolbar.Plus.webp" },
                { DrawMode.RoleTankImage, "PluginImages.toolbar.Tank.webp" },
                { DrawMode.RoleHealerImage, "PluginImages.toolbar.Healer.webp" },
                { DrawMode.RoleMeleeImage, "PluginImages.toolbar.Melee.webp" },
                { DrawMode.RoleRangedImage, "PluginImages.toolbar.Ranged.webp" },
                { DrawMode.Party1Image, "PluginImages.toolbar.Party1.webp" },
                { DrawMode.Party2Image, "PluginImages.toolbar.Party2.webp" },
                { DrawMode.Party3Image, "PluginImages.toolbar.Party3.webp" },
                { DrawMode.Party4Image, "PluginImages.toolbar.Party4.webp" },
                { DrawMode.Party5Image, "PluginImages.toolbar.Party5.webp" },
                { DrawMode.Party6Image, "PluginImages.toolbar.Party6.webp" },
                { DrawMode.Party7Image, "PluginImages.toolbar.Party7.webp" },
                { DrawMode.Party8Image, "PluginImages.toolbar.Party8.webp" },
                { DrawMode.Bind1Image, "PluginImages.toolbar.bind1.webp" },
                { DrawMode.Bind2Image, "PluginImages.toolbar.bind2.webp" },
                { DrawMode.Bind3Image, "PluginImages.toolbar.bind3.webp" },
                { DrawMode.Ignore1Image, "PluginImages.toolbar.ignore1.webp" },
                { DrawMode.Ignore2Image, "PluginImages.toolbar.ignore2.webp" },
                { DrawMode.WaymarkAImage, "PluginImages.toolbar.A.webp" },
                { DrawMode.WaymarkBImage, "PluginImages.toolbar.B.webp" },
                { DrawMode.WaymarkCImage, "PluginImages.toolbar.C.webp" },
                { DrawMode.WaymarkDImage, "PluginImages.toolbar.D.webp" },
                { DrawMode.Waymark1Image, "PluginImages.toolbar.1_waymark.webp" },
                { DrawMode.Waymark2Image, "PluginImages.toolbar.2_waymark.webp" },
                { DrawMode.Waymark3Image, "PluginImages.toolbar.3_waymark.webp" },
                { DrawMode.Waymark4Image, "PluginImages.toolbar.4_waymark.webp" },
                ...
                { DrawMode.GazeImage, "PluginImages.svg.gaze.webp" },
                { DrawMode.TowerImage, "PluginImages.svg.tower.webp" },
                ...
                { DrawMode.TextTool, "" },
                { DrawMode.EmojiImage, "" },
                { DrawMode.StatusIconPlaceholder, "PluginImages.toolbar.StatusPlaceholder.webp" },
                { DrawMode.RoleCasterImage, "PluginImages.toolbar.caster.webp" },
                // Arenas
                { DrawMode.ArenaM9, "PluginImages.toolbar.m9.webp" },
                { DrawMode.ArenaM10, "PluginImages.toolbar.m10.webp" },
                { DrawMode.ArenaM11P1, "PluginImages.toolbar.m11p1.webp" },
                { DrawMode.ArenaM11P2, "PluginImages.toolbar.m11p2.webp" },
                { DrawMode.ArenaM12P1, "PluginImages.toolbar.m12p1.webp" },
                { DrawMode.ArenaM12P2, "PluginImages.toolbar.m12p2.webp" },
                { DrawMode.ArenaTMT1, "PluginImages.toolbar.tmtboss1_arena.webp" },
                { DrawMode.ArenaTMT2, "PluginImages.toolbar.tmtboss2_arena.webp" },
                { DrawMode.ArenaTMT3, "PluginImages.toolbar.tmtboss3_arena.webp" },
                { DrawMode.ArenaUMADP1, "PluginImages.toolbar.p1_fg.webp" },
                { DrawMode.ArenaUMADP2, "PluginImages.toolbar.p2_fg.webp" },

                // Numbered Roles
                { DrawMode.RoleTank1Image, "PluginImages.toolbar.tank_1.webp" }, { DrawMode.RoleTank2Image, "PluginImages.toolbar.tank_2.webp" },
                { DrawMode.RoleHealer1Image, "PluginImages.toolbar.healer_1.webp" }, { DrawMode.RoleHealer2Image, "PluginImages.toolbar.healer_2.webp" },
                { DrawMode.RoleMelee1Image, "PluginImages.toolbar.melee_1.webp" }, { DrawMode.RoleMelee2Image, "PluginImages.toolbar.melee_2.webp" },
                { DrawMode.RoleRanged1Image, "PluginImages.toolbar.ranged_dps_1.webp" }, { DrawMode.RoleRanged2Image, "PluginImages.toolbar.ranged_dps_2.webp" },

                // Added Job Icons
                { DrawMode.JobPldImage, "PluginImages.toolbar.pld.webp" }, { DrawMode.JobWarImage, "PluginImages.toolbar.war.webp" },
                { DrawMode.JobDrkImage, "PluginImages.toolbar.drk.webp" }, { DrawMode.JobGnbImage, "PluginImages.toolbar.gnb.webp" },
                { DrawMode.JobWhmImage, "PluginImages.toolbar.whm.webp" }, { DrawMode.JobSchImage, "PluginImages.toolbar.sch.webp" },
                { DrawMode.JobAstImage, "PluginImages.toolbar.ast.webp" }, { DrawMode.JobSgeImage, "PluginImages.toolbar.sge.webp" },
                { DrawMode.JobMnkImage, "PluginImages.toolbar.mnk.webp" }, { DrawMode.JobDrgImage, "PluginImages.toolbar.drg.webp" },
                { DrawMode.JobNinImage, "PluginImages.toolbar.nin.webp" }, { DrawMode.JobSamImage, "PluginImages.toolbar.sam.webp" },
                { DrawMode.JobRprImage, "PluginImages.toolbar.rpr.webp" }, { DrawMode.JobVprImage, "PluginImages.toolbar.vpr.webp" },
                { DrawMode.JobBrdImage, "PluginImages.toolbar.brd.webp" }, { DrawMode.JobMchImage, "PluginImages.toolbar.mch.webp" },
                { DrawMode.JobDncImage, "PluginImages.toolbar.dnc.webp" },
                { DrawMode.JobBlmImage, "PluginImages.toolbar.blm.webp" }, { DrawMode.JobSmnImage, "PluginImages.toolbar.smn.webp" },
                { DrawMode.JobRdmImage, "PluginImages.toolbar.rdm.webp" }, { DrawMode.JobPctImage, "PluginImages.toolbar.pct.webp" },
            };
            ...
            this.toolDisplayNames = new Dictionary<DrawMode, string>
            {
                ...
                { DrawMode.ArenaUMADP1, "UMAD P1" }, { DrawMode.ArenaUMADP2, "UMAD P2" },
            };
        }
        ...
        public void DrawLeftToolbar(bool isSessionLocked)
        {
            ...
            using (ImRaii.Disabled(isSessionLocked))
            {
                ...
                var arenaGroup = new ToolbarButton
                {
                    ...
                    SubModes = new List<DrawMode> { DrawMode.ArenaM9, DrawMode.ArenaM10, DrawMode.ArenaM11P1, DrawMode.ArenaM11P2, DrawMode.ArenaM12P1, DrawMode.ArenaM12P2, DrawMode.ArenaTMT1, DrawMode.ArenaTMT2, DrawMode.ArenaTMT3, DrawMode.ArenaUMADP1, DrawMode.ArenaUMADP2 },
                    Tooltip = "Arena Maps"
                };
